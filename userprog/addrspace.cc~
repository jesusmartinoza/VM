...
OpenFile *swapFile; //archivo de intercambio
//----------------------------------------------------------------------
// SwapHeader
...
// then, copy in the code and data segments into memory
	...
	ReadFileIntoBuffer(noffH.code.virtualAddr, executable, noffH.code.size, noffH.code.inFileAddr, buff); //dir,arch,tam,cod,destino
    ...
    if (noffH.initData.size > 0) {
       ...
       ReadFileIntoBuffer(noffH.initData.virtualAddr, executable, noffH.initData.size, noffH.initData.inFileAddr, buff);
...
int AddrSpace::ReadFileIntoBuffer(int virtAddr, OpenFile* file, int size, int fileAddr, char* into)
{
	...
	int location;
	//ciclo que va leyendo de la dir virtAddr sumándole lo que va hasta que y ano queda nada de los parametros pasados, devuelve el tam del archivo y el buff ahora tiene el archivo a escribir.
	while(left>0)
	{
